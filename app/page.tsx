    ...
    <div className="min-h-full">
      ...
      <main>
        <section className="mx-auto max-w-6xl px-5 pb-16 pt-8 md:pt-16">
          <p className="mb-5 text-[0.72rem] uppercase tracking-[0.22em] text-brass">Harbor Church · demo inside</p>
          <h1 className="max-w-4xl font-serif text-5xl leading-[1.05] tracking-tight text-ink sm:text-7xl">
          ...
          <div className="paper-card overflow-hidden rounded-[2rem]">
            <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
              <div className="border-b border-line p-6 md:p-10 lg:border-b-0 lg:border-r">
                ...
                <h2 className="mt-2 font-serif text-3xl">Order of service</h2>
                <ol className="mt-8 space-y-4">
                  {[
                    ...
                    <li key={n} className="flex items-baseline gap-4 border-b border-line/70 pb-4">
              ...
              <div className="bg-sage-deep p-6 text-[#f6f1e8] md:p-10">
                <p className="text-[0.7rem] uppercase tracking-[0.18em] text-brass-soft">Media readiness</p>
                <p className="mt-4 font-serif text-4xl leading-tight">Rehearse without leaving the vestry.</p>
                <p className="mt-4 text-[#f6f1e8]/70">
        ...
        <section className="mx-auto max-w-6xl px-5 pb-20">
          <div className="grid gap-6 md:grid-cols-3">
            {FEATURES.map((feature) => (
              <article key={feature.title} className="paper-card rounded-3xl p-6">
                <p className="field-label">{feature.kicker}</p>
                <h3 className="mt-2 font-serif text-2xl leading-tight">{feature.title}</h3>
        ...
        <section className="mx-auto max-w-6xl px-5 pb-24">
          <div className="rounded-[2rem] bg-ink px-6 py-12 text-paper md:px-12">
            <p className="text-[0.7rem] uppercase tracking-[0.18em] text-brass-soft">Not another purple dashboard</p>
            ...
            <Link href="/login" className="btn btn-brass mt-8">
      ...
      <footer className="border-t border-line px-5 py-8 text-sm text-muted">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <VestryMark />
          <p>A worship planning MVP. Demo accounts persist your session.</p>
        </div>
      </footer>
    </div>
  );
